...
module('Unit | Utility | date-to-string#pad', function() {
...
module('Unit | Utility | date-to-string#toMonthString', function() {
  test('It stringifies to month', (assert) => {
    assert.equal(toMonthString(new Date(2015, 9)), '2015-10');
  });
});

module('Unit | Utility | date-to-string#toWeekString', function() {
  test('It stringifies to week', (assert) => {
    assert.equal(toWeekString(new Date(2016, 1, 16)), '2016-W7');
  });
});

module('Unit | Utility | date-to-string#fromWeekString', function() {
...
module('Unit | Utility | date-to-string#formatTimeZoneOffset', function() {
